...
ALTER TABLE contact_groups
  ...
  ADD COLUMN IF NOT EXISTS join_password_hash TEXT;-- Track when members depart without deleting their membership history
ALTER TABLE group_memberships
  ADD COLUMN IF NOT EXISTS departed_at TIMESTAMPTZ;-- Optimize lookups for active members
