-- Manual RLS re-enablement script for production
-- Run this in your Supabase SQL Editor if you can't use local development
...
WHERE schemaname = 'public' 
  AND tablename IN ('profiles', 'contact_groups', 'group_memberships')
ORDER BY tablename;